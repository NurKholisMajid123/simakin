                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <button type="button" class="btn btn-sm btn-warning d-flex align-items-center gap-1"
                                        data-bs-toggle="modal" data-bs-target="#editModal{{ $ruangan->id }}">
                                        <i class="bi bi-pencil"></i> Edit
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger d-flex align-items-center gap-1 mt-1"
                                        data-bs-toggle="modal" data-bs-target="#deleteModal{{ $ruangan->id }}">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.ruangan.destroy', $ruangan->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <p>Apakah Anda yakin ingin menghapus ruangan
                                                    <strong>{{ $ruangan->name }}</strong>?</p>
